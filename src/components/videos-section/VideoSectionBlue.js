...
function VideoSectionBlue({data}) {
    const blueSectionVideo = data.blueSectionVideo
    
    return (
        <article className="section-media">
            <header className="container-faq">
                <h2 dangerouslySetInnerHTML={{__html: data.blueSectionVideoSectionTitle}}/>
            </header>
                ...
                <div className="media">
                    <div>
                        <div className="media__video">
                            ...
                            width="853"
                            height="480"
                            src={`https://www.youtube.com/embed/${blueSectionVideo.blueSectionVideoVideoID}`}
                            frameBorder="0"
