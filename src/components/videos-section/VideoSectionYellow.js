...
function VideoSectionYellow({data}) {
    console.log('VideoSectionYellow', VideoSectionYellow)
  return (
    <article className="section-media">
        <header className="container-faq">
            <h2 dangerouslySetInnerHTML={{__html: data.videoSectionTitle}}/>
        </header>
...
export default VideoSectionYellow